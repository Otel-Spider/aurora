  ...
  return (
    <section className="rooms-section">
      <div className="container">
        <h2 className="rooms-title">Our beautiful, restful rooms</h2>
            ...
            <div className="rooms-wrap">
              <Swiper
                ...
                breakpoints={{
                  ...
                  768: { slidesPerView: 3.8, spaceBetween: 10 },
                ...
                {data.map(room => (
                  <SwiperSlide key={room.id} className="rooms-slide">
                    ...
                    <div className="rooms-body">
                      ...
                      <div className="rooms-features-grid">
                        <div className="rooms-feat">
