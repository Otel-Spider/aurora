...
const BookingBar = ({
  ...
  dateLabel = "Dates",
  dateValue = "09 Oct – 14 Oct",
  guestsLabel = "Rooms & Guests",
  guestsValue = "1 room – 2 guests",
  price = { amount: "1444.95", currency: "USD", meta: "5 nights – 2 guests" },
  onOpenDates,
  onOpenGuests,
  onBook
}) => {
